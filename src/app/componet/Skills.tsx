...
const Skills = () => {
  const skills = [
    ...
    { img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg', title: 'Next.js' },
    { img: 'https://seeklogo.com/images/T/tailwind-css-logo-5AD4175897-seeklogo.com.png', title: 'Tailwind CSS' },
    { img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg', title: 'Bootstrap' },
    { img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg', title: 'Node.js' },
    { img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg', title: 'Express.js' },
    { img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg', title: 'MongoDB' },
    { img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg', title: 'MySQL' },
    { img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firebase/firebase-plain.svg', title: 'Firebase' },
    { img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg', title: 'Python' },
    { img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg', title: 'Java' },
    ...
    { img: 'https://avatars.githubusercontent.com/u/95789578?s=200&v=4', title: 'Gemini AI' },
  ...
  return (
    <section className="skills" id="skills">
      ...
      <p className="description">These are <span>the technologies I've worked with</span></p>
